...
class PostGroupChatBloc extends Bloc<BaseGroupChatEvent, GroupChatState> {
  ...
  PostGroupChatBloc({required this.postGroupMassageUseCase}) : super(GroupChatInitial()) {
...
result.fold((l) => emit(PostGroupChatSucsses(massage: l)), (r) => emit(PostGroupChatError(error: DioHelper().getTypeOfFailure(r))));
