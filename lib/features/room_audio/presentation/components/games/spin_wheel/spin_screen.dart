                      ...
                      SizedBox(
                        ...
                        child: FortuneWheel(
                          ...
                          items: [
                            ...
                            if(widget.isFree) for (var name in widget.list) FortuneItem(child: Text(name), style: FortuneItemStyle(color: _getFillColor(ColorManager.mainColorList, widget.list.indexOf(name), widget.list.length))),
                          ],
                        ),
                      ),
