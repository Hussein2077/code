                  ...
                  builder: (context, count, _) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (GiftUser.userOnMicsForGifts[seatsIndex[index]]
                                  ?.name ==
                            ...
                            return InkWell(
                              onTap: () {
                                setState(() {
                                  ...
                                  if (GiftUser.userSelected.length !=
                                      GiftUser.userOnMicsForGifts.length) {
                                    selectedValue = "";
                                  } else {
                                ...
                                children: [
                                  Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                          width: GiftUser.userSelected
                                                  .containsKey(index)
                                              ? 1.5
                                              : 0,
                                          color: GiftUser.userSelected
                                                  .containsKey(index)
                                              ? ColorManager.mainColor
                                              : Colors
                                                  .transparent, // red as border color
                                        ),
                                  ...
                                  if (RoomScreen.adminsInRoom.containsKey(
                                      GiftUser
                                          .userOnMicsForGifts[seatsIndex[index]]
                                          ?.id
                                          .toString()))
                                    Positioned(
                                  ...
                                  if (GiftUser
                                    ...
                                    Positioned(
                                      ...
                                      child: SizedBox(
                                          ...
                                          height: ConfigSize.defaultSize! * 1.5,
                                          child:
                                              Image.asset(AssetsPath.hostMark)),
                                    ),
                                  if (GiftUser
                                              .userOnMicsForGifts[
                                                  seatsIndex[index]]
                                      ...
                                      !RoomScreen.adminsInRoom.containsKey(
                                          GiftUser.userOnMicsForGifts[index]?.id
                                              .toString()))
                                    Positioned(
                                      top: ConfigSize.defaultSize! * 3,
                                      left: ConfigSize.defaultSize! * 1.3,
                                          ...
                                          child: Center(
                                            child: Text(
                                              ZegoLiveAudioRoomManagers()
                                                      ...
                                                      null
                                                  ? "0"
                                                  : "${ZegoLiveAudioRoomManagers().seatManager!.getIndexByUserID(GiftUser.userOnMicsForGifts[seatsIndex[index]]!.id)}",
                                              style: TextStyle(
                    ...
                    if (GiftUser.userSelected.isEmpty) {
                      ...
                      for (int i = 0;
                        ...
                        GiftUser.userSelected.putIfAbsent(
                            ...
                            () => SelecteObject(
                                userId: GiftUser
                                        .userOnMicsForGifts[seatsIndex[i]]
                                        ?.id ??
                                    "",
                                selected: true));
                      }
                    ...
                    if (GiftUser.userSelected.isEmpty) {
                      ...
                      for (int i = 0; i < widget.listAllUsers.length; i++) {
                        GiftUser.userSelected.putIfAbsent(
                            i,
                            () => SelecteObject(
                                userId: widget.listAllUsers[i].id,
                                selected: true));
                      }
                    } else {
                      setState(() {
