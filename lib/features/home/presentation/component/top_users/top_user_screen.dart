...
class _TopUsersScreenState extends State<TopUsersScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: ScreenColorBackGround(
...
const HeaderWithOnlyTitle(title: StringManager.rank),
 TypeTabs(typeController: typeController,),
   SizedBox(height: ConfigSize.defaultSize!*3,),           
 ...
 Expanded(
   child: TabBarView(
    ...
    children: [
       TopUsersTypeBody(timeController: hostTimeController,),
        TopUsersTypeBody(timeController: userTimeController,)
