...
class SignInWithPlatformBloc extends Bloc<BaseSignInWithPlatformEvent, SignInWithPlatformState> {
  ...
  SignInWithPlatformBloc({required this.signInWithGoogleUC}) : super(SignInWithPlatformInitial()) {
    on<SiginGoogleEvent>((event, emit)async {
      ...
      result.fold((l) => emit(SiginWithGoogleSuccesMessageState(userData: l)), (r) => emit(SiginWithGoogleErrorMessageState(errorMessage: DioHelper().getTypeOfFailure(r))));
