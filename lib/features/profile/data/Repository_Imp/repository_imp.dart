...
try {
  ...
  Future<Either<String, Failure>> deleteMomentComment(DeleteMomentCommentPrameter deleteMomentCommentPrameter)async {
     try {
      final result = await baseRemotlyDataSourceProfile.deleteMomentComment(deleteMomentCommentPrameter) ;
      return left(result);
    } on Exception catch (e) {
      return Right(DioHelper.buildFailure(e));
    }
  ...
  Future<Either<List<MomentCommentModel>, Failure>> getMomentComment(GetMomentCommentPrameter getMomentCommentPrameter) async{
      try {
      final result = await baseRemotlyDataSourceProfile.getMomentComment(getMomentCommentPrameter) ;
      return left(result);
    } on Exception catch (e) {
      return Right(DioHelper.buildFailure(e));
    }
