...
class ChangeNumberNewScreen extends StatefulWidget {
  String oldCode;
  ChangeNumberNewScreen({super.key, required this.oldCode});

  @override
  State<ChangeNumberNewScreen> createState() => ChangeNumberNewScreenState();
}
...
class ChangeNumberNewScreenState extends State<ChangeNumberNewScreen> {
        ...
        if (state is SendCodeSuccesMessageState) {
          Navigator.pushNamed(context, Routes.otp,
              arguments: OtbScreenParm(
                  otpFrom: OtpFrom.changePhoneNew,
                  oldCode: widget.oldCode,
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ChangePhoneWithCountry(hintText: StringManager.enterNewPhone.tr(),),
                          const Spacer(
                            flex: 2,
                          ),
