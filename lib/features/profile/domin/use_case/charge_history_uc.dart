...
class ChargeHistoryUseCases extends BaseUseCase <ChargeHistoryModel,String>{
  BaseRepositoryProfile chargeHistoryUc;


  ChargeHistoryUseCases({required this.chargeHistoryUc});

  @override
  Future<Either<ChargeHistoryModel, Failure>> call(String parameter) {

    return chargeHistoryUc.getChargeHistory(parameter);
