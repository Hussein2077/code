...
class UpdateRoomScreen extends StatefulWidget {
  ...
  const UpdateRoomScreen({this.isUpdate, this.roomDate,  this.roomIntro ,
    this.data,required this.myDataModel, Key? key})
      : super(key: key);
    ...
    return BlocConsumer<OnRoomBloc, OnRoomStates>(
          ...
          return SingleChildScrollView(
            child: Container(
              ...
              child: Scaffold(
                ...
                body: Padding(
                  padding:  EdgeInsets.symmetric(horizontal: ConfigSize.defaultSize! * 2.11),
                  child: Column(
                    ...
                    children: [
                      ...
                      const Spacer(
                        flex:1,
                           ...
                           Container(
                        padding:
                             EdgeInsets.symmetric(horizontal: ConfigSize.defaultSize! * 2.11),
                        decoration: BoxDecoration(
                                        ...
                                        showDialog(
                                            ...
                                            builder: (context) {
                                              return DialogForPrivecyScreen(
                                                flag: widget.myDataModel.vip1!.level! >=
                                                    6
                                                    ? true
                                                    : false,
                                                ...
                                                text: StringManager.privilegeVip6.tr(),
                                              );
                                            });
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                Switch(
                                    ...
                                    onChanged: (value) {
                                      if (!(widget.myDataModel.isHideRoom ?? false)) {
      ...
      listener: (context, state) {
        if (state is UpdateRoomSucsseState) {
          Navigator.pop(context);
          sucssesToast(context: context, title: StringManager.updateScssfuly.tr()) ;
        }
