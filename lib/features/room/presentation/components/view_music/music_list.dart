...
class MusicListWidget extends StatefulWidget {
  ...
  final void Function() refreshMusicScreen ;


  const MusicListWidget({super.key, required this.ownerId,required this.refreshMusicScreen});
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return  ListTile(
                       ...
                       if(RoomScreen.musicesInRoom.contains(MusicObject(duration: item.data![index].duration! , name: item.data![index].title , uri:item.data![index].uri! ) ) ){

                       }else{
                         setState(() {
                           RoomScreen.musicesInRoom.add(
                               MusicObject(duration: item.data![index].duration! ,
                          ...
                          if(mapChachedMusic.containsKey(widget.ownerId)){
                            ...
                            mapChachedMusic.putIfAbsent(widget.ownerId, () => RoomScreen.musicesInRoom);
                          }
                         });
                      ...
                      widget.refreshMusicScreen();
                       ...
                       decoration: BoxDecoration(
                           color:
                           RoomScreen.musicesInRoom.contains(MusicObject(duration: item.data![index].duration! ,
                               name: item.data![index].title , uri:item.data![index].uri! )) ?
                           ColorManager.lightGray: ColorManager.mainColor,
                       ...
                       child: Text(
                         ...
                         StringManager.added.tr() :StringManager.add.tr(),
...
class MusicObject extends Equatable{
  ...
  final   int  duration ;
   ...
   const MusicObject({ required this.uri, required this.name,required this.duration});



  MusicObject.fromJson(Map<String, dynamic> json)
      : name = json['name'],
        uri = json['uri'], duration= json['duration'];
