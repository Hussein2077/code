...
class BanFromWrite extends StatelessWidget {
  ...
  const BanFromWrite({required this.roomData , required this.userData , super.key});
                ...
                child: BlocBuilder<OnRoomBloc, OnRoomStates>(
                  builder: (context, state) {
                    if (state is BanUserFromWritingSuccessState) {
                      if (RoomScreen.banedUsers
                          .containsKey(userData.id.toString())) {
                        return Column(
                          children: [
                            InkWell(
                              onTap: () {
                              ...
                              child:   Icon(Icons.lock_open,color: ColorManager.gray,size: ConfigSize.defaultSize! * 1.8),
                            ),
                            Text(StringManager.writeUnBan.tr() ,style: const TextStyle(
                        ...
                        return Column(
                          children: [
                            InkWell(
                              ...
                              child:
                                    Icon(Icons.lock,color: ColorManager.gray,size: ConfigSize.defaultSize! * 1.8),

                            ),
                             Text(StringManager.writeBan.tr() ,style: const TextStyle(
