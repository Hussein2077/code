...
import 'package:tik_chat_v2/zego_code_v2/zego_uikit/src/plugins/signaling/impl/core/invitation_data.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_uikit/src/plugins/signaling/impl/core/notification_data.dart';
...
class ZegoSignalingPluginCoreData
  ...
  void onNotificationArrived(
    ...
    ZegoLoggerService.logInfo(
      'notification arrived, ${event.toString()}',
      tag: 'uikit',
      subTag: 'signaling core data',
    );
  }
  ...
  void onNotificationClicked(
    ...
    ZegoLoggerService.logInfo(
      'notification clicked, ${event.toString()}',
      tag: 'uikit',
      subTag: 'signaling core data',
    );
  }
  ...
  void onNotificationRegistered(
    ...
    ZegoLoggerService.logInfo(
      'notification registered, ${event.toString()}',
      tag: 'uikit',
      subTag: 'signaling core data',
    );
  }
