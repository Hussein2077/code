...
import 'package:tik_chat_v2/zego_code_v2/zego_uikit/src/services/defines/room_defines.dart';
...
import 'package:tik_chat_v2/zego_code_v2/zego_uikit/src/services/internal/core/zego_uikit_core_event.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_uikit/src/services/internal/core/zego_uikit_core_message.dart';
...
class ZegoUIKitCore with ZegoUIKitCoreEvent {
  ...
  Future<String> getZegoUIKitVersion() async {
    ...
    const zegoUIKitVersion = 'zego_uikit:2.6.0; ';
  ...
  void onInternalCustomCommandReceived(
    ...
    if (extraInfos.keys.contains(removeUserInRoomCommandKey) &&
      ...
      final mapData =
      extraInfos[turnMicrophoneOffInRoomCommandKey] as Map<String, dynamic>;
      final userID = mapData[userIDCommandKey] ?? '';
      final muteMode = mapData[muteModeCommandKey] as bool? ?? false;
