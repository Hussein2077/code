...
// Project imports:
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/components/avatar_default_item.dart';
      ...
      onPressed: () {
        ...
        if (popupItems.isNotEmpty) {
          showPopUpSheet(
            ...
            innerText: widget.innerText, roomData: widget.roomData,
            myDataModel: widget.myDataModel, layoutMode: widget.layoutMode,
          );
        }
      },
    );
        ...
        child: AnimatedPadding(
          ...
          child: Container(
            ...
            child: ZegoMemberListSheet(
              ...
              innerText: innerText,
              onMoreButtonPressed: onMoreButtonPressed, roomData:roomData,
