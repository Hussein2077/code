...
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/components/effects/sound_effect_button.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/components/leave_button.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/components/member/member_button.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/components/message/in_room_message_button.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/connect/connect_button.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/connect/connect_manager.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/connect/defines.dart';
import 'package:tik_chat_v2/zego_code_v2/zego_live_audio_room/src/connect/host_lock_seat_button.dart';
          ...
          ValueListenableBuilder<bool>(
              ...
              builder:(context,value,_){
                ...
                if ( RoomScreen.showMessageButton.value
                    && !RoomScreen.banedUsers.containsKey(widget.myDataModel.id.toString())) {
                  return   SizedBox(
                    height: 124.r,
                    child: Row(
                      ...
                      children: [
                        ...
                        ZegoInRoomMessageButton(roomData: widget.roomData, myData:widget.myDataModel,),
                      ],
                    ),
                  ) ;
                } else {
    ...
    switch (type) {
      case ZegoMenuBarButtonName.showMemberListButton:
        return ZegoMemberButton(
          ...
          roomData: widget.roomData, myDataModel: widget.myDataModel, layoutMode:widget.layoutMode ,
        );
      case ZegoMenuBarButtonName.toggleMicrophoneButton:
        ...
        return ZegoToggleMicrophoneButton(
          ...
          //   backgroundColor: Colors.white,
          // ),
          zegoLiveSeatManager: widget.seatManager,
