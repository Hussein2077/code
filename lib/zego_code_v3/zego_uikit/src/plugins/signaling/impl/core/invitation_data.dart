...
mixin ZegoSignalingPluginCoreInvitationData {
    ...
    return ZegoPluginAdapter()
      ...
      if (result.error == null) {
        ...
        final invitationData = InvitationData(
          ...
          type: type,
          data: kitData,
          resourceID: notificationConfig?.resourceID ?? '',
        );
  ...
  // ------- events ------
  var streamCtrlInvitationUserStateChanged =
      StreamController<List<ZegoSignalingPluginInvitationUserInfo>>.broadcast();
  ...
  void onInvitationUserStateChanged(
    ...
    streamCtrlInvitationUserStateChanged.add(event.callUserList);
  }
