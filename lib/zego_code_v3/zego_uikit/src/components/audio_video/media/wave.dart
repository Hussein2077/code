...
/// @nodoc
class ZegoMediaWaveform extends StatefulWidget {
  final Stream<double> soundLevelStream;
  final ValueNotifier<MediaPlayState> playStateNotifier;

  const ZegoMediaWaveform({
    Key? key,
  ...
  @override
  State<ZegoMediaWaveform> createState() => _ZegoMediaWaveformState();
}

/// @nodoc
class _ZegoMediaWaveformState extends State<ZegoMediaWaveform> {
  ...
  void onPlayStateChanged() {
    ...
    isPlaying.value = MediaPlayState.Playing == playState;
  }
}
