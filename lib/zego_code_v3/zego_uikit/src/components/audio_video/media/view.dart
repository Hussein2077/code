...
import 'package:tik_chat_v2/zego_code_v3/zego_uikit/src/components/audio_video/media/wave.dart';
...
/// 2. media view
/// 3. foreground view
class ZegoMediaView extends StatefulWidget {
  const ZegoMediaView({
    Key? key,
    required this.user,
  ...
  @override
  State<ZegoMediaView> createState() => _ZegoMediaViewState();
}

/// @nodoc
class _ZegoMediaViewState extends State<ZegoMediaView> {
  @override
  ...
  Widget mediaView() {
    ...
    return SizedBox.expand(
      child: ValueListenableBuilder<MediaType>(
