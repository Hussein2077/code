...
class ZegoREdgeInsets extends EdgeInsets {
  ...
  ///
  /// ```dart
  /// const ZegoREdgeInsets.symmetric(vertical: 8.0)
  /// ```
  /// {@end-tool}
  ...
  ///
  /// ```dart
  /// const ZegoREdgeInsets.only(left: 40.0)
  /// ```
  /// {@end-tool}
...
class ZegoREdgeInsetsDirectional extends EdgeInsetsDirectional {
  ...
  ///
  /// ```dart
  /// const ZegoREdgeInsetsDirectional.all(8.0)
  /// ```
  /// {@end-tool}
  ...
  ///
  /// ```dart
  /// const ZegoREdgeInsetsDirectional.only(start: 40.0)
  /// ```
  /// {@end-tool}
