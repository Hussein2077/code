...
extension MediaPlayStateExtension on MediaPlayState {
  static MediaPlayState fromZego(ZegoMediaPlayerState zegoMediaPlayerState) {
    switch (zegoMediaPlayerState) {
      case ZegoMediaPlayerState.NoPlay:
        return MediaPlayState.NoPlay;
      case ZegoMediaPlayerState.Playing:
        return MediaPlayState.Playing;
      case ZegoMediaPlayerState.Pausing:
        return MediaPlayState.Pausing;
      case ZegoMediaPlayerState.PlayEnded:
        return MediaPlayState.PlayEnded;
    }
  }
}
