...
//zego
  ...
  static String rpsGameResultKey = "${StringManager.result}${RoomScreen.differentCommentKey}rps";
  static String diceGameResultKey = "${StringManager.result}${RoomScreen.differentCommentKey}dice";
