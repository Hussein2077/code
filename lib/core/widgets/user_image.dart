...
class UserImage extends StatelessWidget {
  ...
  const UserImage({this.frameId , this.frame ,  this.child ,  required this.image , this.boxFit ,this.imageSize, super.key});
  ...
  Widget build(BuildContext context) {
   ...
   return    Container(
          ...
          decoration:  BoxDecoration(
              ...
              image: DecorationImage(
                fit: boxFit??BoxFit.fill,
                  image: const AssetImage( AssetsPath.defaultImage,) )),
                    child: child,
        );
     }
